        ...
        binding?.btnSubmit?.setOnClickListener {
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    if (isEdit) {
                        noteAddUpdateViewModel.update(note as NoteData)
                        showToast(getString(R.string.changed))
                    } else {
                        note.let { note ->
                            note?.date = DateHelper.getCurrentDate()
                        }
                        noteAddUpdateViewModel.insert(note as NoteData)
    ...
    private fun showAlertDialog(type: Int) {
        ...
        with(alertDialogBuilder) {
            ...
            setPositiveButton(getString(R.string.yes)) { _, _ ->
                if (!isDialogClose) {
                    noteAddUpdateViewModel.delete(note as NoteData)
...
//ini sudah di hubungkan anatara NoteAddUpdateViewModel dan NoteAddUpdateActivity
